...
<div class="projects box-wrap">
    <el-form @submit.native.prevent>
        ...
        <!--<el-form-item>
            <el-button v-hasPermission="'link:add'" type="primary" @click="resetForm(false)">新增</el-button>
            <el-button v-hasPermission="'link:delete'" @click="handleDel">删除</el-button>
        </el-form-item>-->
    </el-form>
...
<script>
    ...
    methods: {
        ...
        confirmDel () {
            ...
            this.$post('/link/delete', params).then(res => {
                if (res) {
        ...
        handleSave () {
            let url = this.addForm.title === '新增' ? '/room/add' : '/room/update'
        ...
        init () {
            ...
            this.$post('/room/memQuery', params).then(res => {
                if (res) {
